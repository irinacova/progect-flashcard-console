...
inquirer
    .prompt([
        ...
        {
            type: 'list',
            name: professionArr[0].question,
            choices: professionArr[0].answers
        },
        {
            type: 'list',
            name: professionArr[1].question,
            choices: professionArr[1].answers
        },
        {
            type: 'list',
            name: professionArr[2].question,
            choices: professionArr[2].answers
        },
        {
            type: 'list',
            name: professionArr[3].question,
            choices: professionArr[3].answers
        },
        {
            type: 'list',
            name: professionArr[4].question,
            choices: professionArr[4].answers
        }
    ])
